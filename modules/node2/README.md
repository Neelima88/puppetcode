...
1. [Setup - The basics of getting started with node2](#setup)
    * [What node2 affects](#what-node2-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with node2](#beginning-with-node2)
